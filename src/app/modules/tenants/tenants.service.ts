...
export class TenantsService {
  ...
  async create(createTenantDto: CreateTenantDto): Promise<Tenant> {
    ...
    await this.configurationsService.create({ tenantId: createdTenant.id });

    // Initialize default organizational structure (Root CEO node)
    await this.configurationsService.initializeDefaultStructure(createdTenant.id);
